...
def sendemail(fromname, fromaddr, subject, msg):
    ...
    username = 'likemike303@gmail.com'       #INSERT email address
    password = ''                            #INSERT email app passowrd

    toname = 'You'                               #RECIPIENT NAME
    toaddr = 'likemike11@yahoo.com'              #RECIPIENT ADDRESS
